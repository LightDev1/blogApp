...
export default function CreateBlock() {
    ...
    const handlerClick = async () => {
        try {
            const data = await request('/api/posts/publish', 'POST', { title, text, thumbnail }, {
            ...
            message('Превышен размер файла превью');
        }
    };
                ...
                <div className="thumbnail-info">
                    ...
                    <div className="thumbnail">
                        <div className="thumbnail-preview">
                            <img src={thumbnail ? thumbnail : noThumbnail} alt="thumbnail" />
                        </div>
